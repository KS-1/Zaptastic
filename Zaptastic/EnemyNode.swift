...
class EnemyNode: SKSpriteNode {
    ...
    func fire() {
        ...
        weapon.physicsBody?.mass = 0.001 // Low mass since it's a laser weapon in space
        
        let speed: CGFloat = 1
        /// Find angle of the blast based on the location of the enemy relative to the player
        /// In SpriteKit and UIKit the angle is determined using Raidans
        let adjustedRotation = zRotation + (CGFloat.pi / 2)
        
        /// Math for getting the position
